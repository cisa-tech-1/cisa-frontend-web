  ...
  return (
    <section className="bg-teal-500 px-5 pb-16 pt-14 md:px-20 md:pb-[100px] md:pt-14">
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-8 md:gap-12">
        <Reveal className="flex max-w-[588px] flex-col items-center gap-[30px] text-center">
        ...
        <Stagger
          key={activeTab}
          className="grid w-full grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-4"
        >
          {members.map((member) => (
            <StaggerItem key={`${activeTab}-${member.name}`}>
