    ...
    <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
      <div className="relative min-h-[300px] flex-1 overflow-hidden rounded-xl bg-[#F4F3FF]">
        ...
        {MAP_MARKERS.map((marker) => (
          <span
            key={marker.name}
            className="absolute flex size-3 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#66C61C] shadow-[0_0_0_6px_rgba(102,198,28,0.2)]"
